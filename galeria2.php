                ...
                while($plik = readdir($uchwyt))
                    {
                        ...
                        if($plik != '.' && $plik != '..' && $sufix == '_i')
                            ...
                            */
                            ...
                            <span class="napis">
                            <span class="icon-bubble tytul"><span class="tytulview" style="display:none">Tytuł zdjęcia</span></span>
                            <span class="icon-clock2 czas"><span class="czasview" style="display:none">2016-02-04</span></span>
                            </span>
                            ';
                            }
                    }
